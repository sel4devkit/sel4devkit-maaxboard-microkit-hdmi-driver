...
#define CURRENT_FRAME_BUFFER_ADDR_OFFSET (FRAME_BUFFER_SIZE * 2) + 200000   // Used to store the current offset to be applied to virtual memory to access the current frame buffer
